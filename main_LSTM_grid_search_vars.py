...
# d_grid_search = pickle.load(open(r"results_grid_search_LSTM.pkl", "rb"))
...
for jj in range(len(hidden_size_array)):
    ...
    print("Validation loss is {:.4f}.".format(loss_scores_valid[jj,:].mean()))
...
pickle.dump(d_save, open("results_grid_search_vars_LSTM.pkl", "wb"))
...
###############################################################################
# # plt.figure()
# # plt.errorbar(x=hidden_size_array[num_layers_array==1],
# #              y=loss_scores_valid_mean[num_layers_array==1],
# #              yerr=loss_scores_valid_sdom[num_layers_array==1],
# #              fmt='-o', label='layers: 1')
# # plt.errorbar(x=hidden_size_array[num_layers_array==2],
# #              y=loss_scores_valid_mean[num_layers_array==2],
# #              yerr=loss_scores_valid_sdom[num_layers_array==2],
# #              fmt='-o', label='layers: 2')
# # plt.errorbar(x=hidden_size_array[num_layers_array==3],
# #              y=loss_scores_valid_mean[num_layers_array==3],
# #              yerr=loss_scores_valid_sdom[num_layers_array==3],
# #              fmt='-o', label='layers: 3')
# # # plt.ylim(0.005, 0.025)
# # plt.title("GRU Average Loss")
