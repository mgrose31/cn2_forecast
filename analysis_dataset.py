...
plt.hist(temp_valid_unique, bins=bins, density=True, alpha=0.6, color='b', label='valid')
plt.hist(temp_test_unique, bins=bins, density=True, alpha=0.6, color='r', label='test')
...
plt.hist(press_valid_unique, bins=bins, density=True, alpha=0.6, color='b', label='valid')
plt.hist(press_test_unique, bins=bins, density=True, alpha=0.6, color='r', label='test')
...
plt.hist(rh_valid_unique, bins=bins, density=True, alpha=0.6, color='b', label='valid')
plt.hist(rh_test_unique, bins=bins, density=True, alpha=0.6, color='r', label='test')
plt.xlim(0, 100)
...
plt.hist(wind_spd_valid_unique, bins=bins, density=True,
         log=True, alpha=0.6, color='b', label='valid')
plt.hist(wind_spd_test_unique, bins=bins, density=True,
         log=True, alpha=0.6, color='r', label='test')
